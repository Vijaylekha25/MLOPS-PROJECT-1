...
class DataProcessor:
    ...
    def __init__(self, train_path, test_path, processed_dif, config_path):
        self.train_path = train_path
        self.test_path = test_path
        self.processed_dir = processed_dif
    ...
    def balance_data(self,df):
        try:
            ...
            logger.error(f"Error during balancing data step step {e}")
    ...
    def save_data(self,df , file_path):
        try:
            logger.info("Saving our data processed folder")
